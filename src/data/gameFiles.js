export const gameFiles = {
  "monster-mixology": [
    ...
    },
    {
      ...
      items: ["Complete Rulebook (English)", "Setup Guide", "Game Variants"],
      requirements: null,
      files: [
        {
    ...
    },
    {
      ...
      items: ["24x New Cards", "1x Special Board", "New Rules Reference"],
      requirements: {
        type: "purchase",
  ...
  variableFiles: {
    "monster-mixology": {
      luckyGenerator: {
        ...
        description:
          "Generate random combinations of ingredients, monsters, and special effects for unique gameplay experiences. Perfect for adding variety to your Monster Mixology sessions!",
      ...
      makeYourOwn: {
        ...
        description:
          "Create your own custom monsters, ingredients, and recipes. Share your creations with other Monster Mixology players!",
