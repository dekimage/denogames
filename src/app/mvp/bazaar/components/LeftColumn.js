...
export default function LeftColumn() {
    ...
    const createElementPattern = (emoji) => {
        return Array(12).fill().map((_, index) => {
            ...
            return (
                <div className="w-[20px] h-[20px] rounded-full border border-gray-300 border-dotted m-auto" />
            );
        });
    };
    ...
    return (
        <div className="w-[250px] border-r border-black p-2">
            ...
            {/* Regular rows */}
            <ItemRow image={<img src="/bazaar/fire.png" alt="Fire" className="w-[40px] h-[40px]" />} cellsConfig={createElementPattern("🔥")} />
            <ItemRow image={<img src="/bazaar/water.png" alt="Fire" className="w-[40px] h-[40px]" />} cellsConfig={createElementPattern("💎")} />
            <ItemRow image={<img src="/bazaar/earth.png" alt="Fire" className="w-[40px] h-[40px]" />} cellsConfig={createElementPattern("🔮")} />
            <ItemRow image={<img src="/bazaar/air.png" alt="Fire" className="w-[40px] h-[40px]" />} cellsConfig={createElementPattern("🌙")} />
