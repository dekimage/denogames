        ...
        <div className="relative w-full h-10">
            ...
            <div className="flex w-full h-full overflow-x-scroll overflow-y-hidden scrollbar-hide font-strike mt-8 lg:mt-2">
                {Array.from({ length: totalSegments }, (_, index) => (
                    <div
                        key={index}
                        className={`relative flex-1 h-[40px] mx-[2px] justify-center items-center text-2xl ${index < filledSegments
...
const RewardsCard = ({ reward, userLevel, onClaim }) => {
    ...
    return (
        <div className="box-inner">
            <div className="box-broken flex justify-between p-4 lg:p-8 mb-4 border h-[160px] w-fit">
