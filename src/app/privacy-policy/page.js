        ...
        <div className="box-combined p-10 py-16">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              us, such as your name, email address, and other information you
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              your experience and to send you promotional materials.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              required by law. We do not sell your personal information to third
              parties.
            </p>
          </section>
